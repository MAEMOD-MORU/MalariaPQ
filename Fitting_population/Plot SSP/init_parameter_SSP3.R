...
mui <- 0.0234     # Monthly mortality rate for birth
muo <- 0.0210    # Monthly mortality rate for death
mui_before <- 0.0234     # Monthly mortality rate for birth
muo_before <- 0.0210    # Monthly mortality rate for death
