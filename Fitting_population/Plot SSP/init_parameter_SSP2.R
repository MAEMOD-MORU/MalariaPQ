...
mui <- 0.0233    # Monthly mortality rate for birth
muo <- 0.0211    # Monthly mortality rate for death
mui_before <- 0.0233     # Monthly mortality rate for birth
muo_before <- 0.0211    # Monthly mortality rate for death
