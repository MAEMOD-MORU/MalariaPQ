...
# save op2
saveRDS(op2, file = "calibration_population_results_SSP3.rds")
fit <- readRDS("calibration_population_results_SSP3.rds")
...
points(seq(2000,2050,5),totalpop_data, col='black', pch=16)
# add points ssp 1-3
